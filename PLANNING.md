...
- [x] Netzwerk: Velocity- oder BungeeCord-Proxy + Subserver als Gruppe verwalten (Velocity: Modern-Forwarding + Paper/Spigot/Fabric/Forge/NeoForge; BungeeCord: IP-Forwarding + Paper/Spigot), eigenes Docker-Netz
